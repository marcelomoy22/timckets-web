...
export class HistoryComponent implements OnInit{
    ...
    ngOnInit(){
      ...
      this.loadSolucionado = true
        this._requestProcesService.getHistory(this.identity).subscribe(
            response=>{
          ...
          this._requestProcesService.getHistorySolucionado(this.identity).subscribe(
            response2=>{
